                                ...
                                <tr class="border-b border-neutral-200 hover:bg-primary/10">
                                    ...
                                    <td class="flex gap-2 whitespace-wrap px-6 py-2 justify-center">
                                        ...
                                        @else
                                            ...
                                            @endif
                                            @if (Auth::user()->role != "admin")
                                                <a href="{{ route('penilaian.edit', ['id' => $item->id]) }}" class="p-1 bg-yellow-200 rounded-md">
...
@section('modal_content')
    <div class="relative rounded-md bg-white p-2 shadow">
        <div class="flex flex-col gap-2">
            ...
            <div>
                @if (Auth::user()->role == "admin")
                    <select name="role" id="selectRole" class="w-full rounded-md" onchange="getRolePenilaian()">
    ...
    @if (Auth::user()->role == "admin")
        <script>
            ...
            function getRolePenilaian() {
                const selectRole = document.getElementById('selectRole');
                getPenilaianData(selectRole.value)
            }

            function getPenilaianData(role) {
                console.log();
                axios.get('/penilaian/admin/getdata/' + role + '/' + id)
                    .then((response) => {
